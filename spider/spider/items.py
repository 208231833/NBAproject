...
class team_data(scrapy.Item):
    ...
    three_percentage=scrapy.Field()
    three_number=scrapy.Field()
    three_out_number=scrapy.Field()
    free_percentage=scrapy.Field()
    free_number=scrapy.Field()
    free_out_number=scrapy.Field()
    All_rebound=scrapy.Field()
    fight_rebound=scrapy.Field()
    defind_rebound=scrapy.Field()
    assist=scrapy.Field()
    fault=scrapy.Field()
    steal=scrapy.Field()
    block=scrapy.Field()
    foul=scrapy.Field()
    scores=scrapy.Field()
class team_info(scrapy.Item):
    url=scrapy.Field()
    name=scrapy.Field()
    enter_time=scrapy.Field()
    home=scrapy.Field()
    web=scrapy.Field()
    coach=scrapy.Field()
